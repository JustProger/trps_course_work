...
urlpatterns = [
    ...
    path('<int:pk>/comment_delete/', views.lead_comment_delete, name='comment_delete'),
    path('<int:pk>/file_delete/', views.lead_file_delete, name='file_delete'),
    path('<int:pk>/edit/', views.LeadUpdateView.as_view(), name='edit'),
    path('<int:pk>/convert/', views.ConverToClientView.as_view(), name='convert'),
